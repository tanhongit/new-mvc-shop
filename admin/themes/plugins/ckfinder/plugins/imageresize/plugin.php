...
if (function_exists('imagecreate')) {
    ...
    $config['Hooks']['BeforeExecuteCommand'][] = [$CommandHandler_ImageResize, 'onBeforeExecuteCommand'];
    $config['Hooks']['BeforeExecuteCommand'][] = [$CommandHandler_ImageResizeInfo, 'onBeforeExecuteCommand'];
    $config['Hooks']['InitCommand'][] = [$CommandHandler_ImageResize, 'onInitCommand'];
