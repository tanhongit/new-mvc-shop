            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="alert alert-warning" role="alert">
                        <strong><?= $post ? 'Cảnh Báo: </strong> Bạn đang trong trang chỉnh sửa của bài viết "' . $post['post_title'] . '", Hãy cẩn trọng!!! <a target="_blank" href="#"> Xem tài liệu hướng dẫn</a>' : 'Cảnh Báo: </strong> Bạn đang trong trang tạo một trang mới, Hãy cẩn trọng!!! <a target="_blank" href="#"> Xem tài liệu hướng dẫn</a>'; ?>
                    ...
                    $get_user_by = getRecord('users', $userNav) ?>
                                    ...
                                    <div class="col-sm-4">
                                            ...
                                            <div class="row clearfix">
                                                <div>
                                                    <div>
                                                        ...
                                                        <?php } else {
                                                            echo '<h6>Chưa có ảnh đại diện</h6>';
                                                        } ?>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row clearfix">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    <input name="totalview" type="text" value="<?= $post ? $post['totalView'] : ''; ?>" class="form-control" id="totalview" placeholder="Lượt view..." />
                                                </div>
                                            </div>
                                        </div>
