                                ...
                                <ul class="comment-reply list-unstyled">
                                    <?php foreach ($orderDetail as $product) : ?>
                                        <li>
                                            ...
                                            <div class="text-box">
                                                <h5><a style="color: #000;" href="product/<?php echo $product['product_id']; ?>-<?php echo $product['slug']; ?>"><?= number_format($product['product_price'], 0, ',', '.') ?>đ</a></a><span style="float: right;"><?= $status[$order['status']] ?></span></h5>
                                    ...
                                    <span> <a href="admin.php?controller=feedback&action=add&order_id=<?= $order['id'] ?>" style="text-decoration: none;" class='btn btn-danger waves-effect'>Phản hồi về đơn hàng này</a>
                                    </span>
                                </ul>
                            </div>
                        </div>
