...
class CKFinder_Connector_CommandHandler_CreateZip extends CKFinder_Connector_CommandHandler_XmlCommandHandlerBase
{
    ...
    public function buildXml()
    {
        ...
        // if we only want to create archive
            ...
            if (file_exists($zipFilePath) && (!isset($_POST['fileExistsAction']) || !in_array($_POST['fileExistsAction'], ['autorename', 'overwrite']))) {
...
if (extension_loaded('zip')) {
    ...
    $config['Hooks']['BeforeExecuteCommand'][] = [$CommandHandler_UnzipHere, 'onBeforeExecuteCommand'];
    $config['Hooks']['BeforeExecuteCommand'][] = [$CommandHandler_UnzipTo, 'onBeforeExecuteCommand'];
    $config['Hooks']['BeforeExecuteCommand'][] = [$CommandHandler_CreateZip, 'onBeforeExecuteCommand'];
    $config['Hooks']['BeforeExecuteCommand'][] = [$CommandHandler_DownloadZip, 'onBeforeExecuteCommand'];
    $config['Plugins'][] = 'zip';
}
