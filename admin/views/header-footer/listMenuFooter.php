            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="admin.php?controller=user">Footer</a></li>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($link_title_footer as $link) : $stt++; ?>
                                            <tr>
                                                ...
                                                <td><?= $link['menu_url'] ?></td>
                                                <td><a href="admin.php?controller=header-footer&amp;action=editMenuFooter&amp;menufooter_id=<?php echo $link['id']; ?>" class="btn btn-default waves-effect waves-float btn-sm waves-green"><i class="zmdi zmdi-edit"></i></a></td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
                                </table>
