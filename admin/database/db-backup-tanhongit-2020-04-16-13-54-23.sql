...
CREATE TABLE `mail` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `mail_host` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mail_port` int(11) DEFAULT NULL,
  `mail_uname` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mail_upass` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mail_template` longtext COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'No',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO mail VALUES("1","smtp.gmail.comư","465","tanhongitverifi@gmail.com","kkgdqneidrcgvqmt","","Yes");
...
INSERT INTO users_online VALUES("ip13q3g2qd2kttsot6onpa6bh1","1587010722","::1","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.163 Safari/537.36","2020-04-16 11:18:42");
