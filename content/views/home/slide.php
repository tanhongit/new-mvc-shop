	...
	<div class="slider" id="revolutionSlider" data-plugin-revolution-slider data-plugin-options='{"startheight": 500}'>
		<ul>
			<li data-transition="fade" data-slotamount="13" data-masterspeed="300">
				...
				<div class="tp-caption main-label sft stb" data-x="135" data-y="170" data-speed="300" data-start="1000" data-easing="easeOutExpo">BÁNH XÈO RAU RỪNG</div>
		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="get-started">
					...
					<div class="learn-more">hoặc đến <a href="#">Thông tin.</a></div>
				</div>
			</div>
		</div>
	</div>
