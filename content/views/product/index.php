                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="summary entry-summary">
                            ...
                            <div class="feedback">
                                <a href="index.php?controller=feedback&action=index&product_id=<?=$product['id']?>"><b>Nhấn vào đây</b></a> để gửi phản hồi về sản phẩm này.
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <li class="col-sm-3 col-xs-12 product">
                                ...
                                <span class="product-thumb-info">
                                    <form action="cart/add/<?php echo $related_product['id']; ?>" method="post">
                                        ...
                                        <a class="add-to-cart-product"><button type="submit" href="cart/add/<?php echo $related_product['id']; ?>"><i class="fa fa-shopping-cart"></i> Thêm vào giỏ hàng</button></a>
                                    </form>
